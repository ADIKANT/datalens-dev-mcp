...
PARAM_DESCRIPTIONS: dict[str, str] = {
    ...
    "scope": "Optional workbook entry scope filter.",
...
def _all_tool_schemas() -> tuple[dict[str, Any], ...]:
    return (
        ...
        _tool_schema("dl_validate_editor_runtime_contract", "Validate Advanced Editor runtime HTML/JS before save or publish."),
        ...
        _tool_schema("dl_reference", "Bounded source-traced DataLens docs, recipe, formula, error, and capability reference."),
