...
TOOLS: dict[str, Callable[..., Any]] = {
    ...
    "dl_preview_dataset_data": data_evidence.dl_preview_dataset_data,
    "dl_prove_dataset_data": data_evidence.dl_prove_dataset_data,
    "dl_diagnose_empty_dataset_result": data_evidence.dl_diagnose_empty_dataset_result,
...
TEST_ONLY_TOOL_PROFILE_MEMBERS: dict[str, set[str]] = {
    ...
    | {
        ...
        "dl_prove_dataset_data",
        "dl_diagnose_empty_dataset_result",
...
TOOL_REQUIRED_FIELDS: dict[str, list[str]] = {
    ...
    "dl_prove_dataset_data": ["spec"],
    "dl_preview_dataset_data": ["dataset_id", "columns"],
...
def _all_tool_schemas() -> tuple[dict[str, Any], ...]:
    return (
        ...
        _tool_schema("dl_prove_dataset_data", "Verify a bounded dataset sample with typed declarative assertions."),
        _tool_schema("dl_diagnose_empty_dataset_result", "Explain an unexpected empty dataset result without guessing."),
        _tool_schema("dl_preview_dataset_data", "Read a bounded typed dataset sample through getDatasetData."),
