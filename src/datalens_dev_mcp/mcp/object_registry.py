...
REGISTRY_SCHEMA_ID = "object_read_registry"
...
OBJECT_READ_CONTRACTS: dict[str, ObjectReadContract] = {
    "html_page": ObjectReadContract(
        ...
        compact_summary_schema="html_page.identity.content.hashes",
        structure_schema="html_page.content.annotation",
        artifact_schema="sanitized_rpc_envelope.html_page",
    ...
    "dashboard": ObjectReadContract(
        ...
        compact_summary_schema="dashboard.identity.tabs.counts.selector_impact.hashes",
        structure_schema="dashboard.tabs.items.links.parameters",
        artifact_schema="sanitized_rpc_envelope.dashboard",
    ...
    "editor_chart": ObjectReadContract(
        ...
        branch_semantics="saved_or_published",
        revision_fields=("revId", "savedId", "entry.revId", "entry.savedId"),
        compact_summary_schema="editor_chart.identity.sections.links.hashes",
        structure_schema="editor_chart.tabs.sources.prepare.controls.config",
        artifact_schema="sanitized_rpc_envelope.editor_chart",
    ...
    "wizard_chart": ObjectReadContract(
        ...
        branch_semantics="saved_or_published",
        revision_fields=("revId", "savedId", "entry.revId", "entry.savedId"),
        compact_summary_schema="wizard_chart.identity.visualization.fields.hashes",
        structure_schema="wizard_chart.visualization.fields.datasets.params",
        artifact_schema="sanitized_rpc_envelope.wizard_chart",
    ...
    "table_node": ObjectReadContract(
        ...
        branch_semantics="saved_or_published",
        revision_fields=("revId", "savedId", "entry.revId", "entry.savedId"),
        compact_summary_schema="editor_table.identity.sections.table_contract.hashes",
        structure_schema="table_node.input.output.sorting.formatting.groups.bars.totals.cross_filter",
        artifact_schema="sanitized_rpc_envelope.table_node",
    ...
    "d3_node": ObjectReadContract(
        ...
        branch_semantics="saved_or_published",
        revision_fields=("revId", "savedId", "entry.revId", "entry.savedId"),
        compact_summary_schema="d3_node.identity.runtime.sections.hashes",
        structure_schema="d3_gravity.configuration.data_contract.runtime",
        artifact_schema="sanitized_rpc_envelope.d3_node",
    ...
    "control_node": ObjectReadContract(
        ...
        branch_semantics="saved_or_published",
        revision_fields=("revId", "savedId", "entry.revId", "entry.savedId"),
        compact_summary_schema="control_node.identity.params.dependencies.hashes",
        structure_schema="control_node.static.dynamic.dependent_selector_contract",
        artifact_schema="sanitized_rpc_envelope.control_node",
    ...
    "markdown_node": ObjectReadContract(
        ...
        branch_semantics="saved_or_published",
        revision_fields=("revId", "savedId", "entry.revId", "entry.savedId"),
        compact_summary_schema="markdown_node.identity.params.mermaid.cross_filter.hashes",
        structure_schema="markdown_node.params.mermaid.cross_filter_values",
        artifact_schema="sanitized_rpc_envelope.markdown_node",
    ...
    "dataset": ObjectReadContract(
        ...
        compact_summary_schema="dataset.identity.fields.sources.hashes",
        structure_schema="dataset.fields.sources.avatars.connection_refs",
        artifact_schema="sanitized_rpc_envelope.dataset",
    ...
    "connection": ObjectReadContract(
        ...
        branch_semantics="unbranched_revisioned",
        revision_fields=("revId", "rev_id", "metadata.revId"),
        compact_summary_schema="connection.identity.type.options.hashes",
        structure_schema="connection.type.params.safe_options",
        artifact_schema="sanitized_rpc_envelope.connection",
    ...
    "ql_chart": ObjectReadContract(
        ...
        branch_semantics="saved_or_published",
        revision_fields=("revId", "savedId", "entry.revId", "entry.savedId"),
        compact_summary_schema="ql_chart.identity.query.dataset_dependency.hashes",
        structure_schema="ql_chart.query.dataset_dependency.behavior",
        artifact_schema="sanitized_rpc_envelope.ql_chart",
    ...
    "report": ObjectReadContract(
        ...
        compact_summary_schema="report.identity.pages.widgets.hashes",
        structure_schema="report.pages.widgets.selectors.settings",
        artifact_schema="sanitized_rpc_envelope.report",
    ...
    "workbook": ObjectReadContract(
        ...
        compact_summary_schema="workbook.identity.collections.permissions.hashes",
        structure_schema="workbook.metadata.collection.refs",
        artifact_schema="sanitized_rpc_envelope.workbook",
    ...
    "collection": ObjectReadContract(
        ...
        branch_semantics="unbranched_revisioned",
        revision_fields=("updatedAt", "createdAt"),
        compact_summary_schema="collection.identity.permissions.hashes",
        structure_schema="collection.metadata.parent.refs",
        artifact_schema="sanitized_rpc_envelope.collection",
    ...
    "permission": ObjectReadContract(
        ...
        revision_fields=(),
        compact_summary_schema="permission.identity.bindings.counts",
        structure_schema="permission.bindings.subjects.roles",
        artifact_schema="sanitized_rpc_envelope.permission",
    ...
    "workbook_permission": ObjectReadContract(
        ...
        revision_fields=(),
        compact_summary_schema="workbook_permission.bindings.counts",
        structure_schema="workbook_permission.bindings.subjects.roles",
        artifact_schema="sanitized_rpc_envelope.workbook_permission",
        dependency_extractors=("permission_subjects",),
        redaction_policy="redact secret-like keys recursively",
        error_categories=("missing_input", "auth_failure", "datalens_validation_error", "unavailable_api_method"),
        evidence_status="official_indexed",
    ...
    "workbook_entry": ObjectReadContract(
        ...
        revision_fields=("revId", "savedId"),
        compact_summary_schema="workbook_entry.inventory_row",
        structure_schema="workbook_entry.available_only_through_getWorkbookEntries",
        artifact_schema="sanitized_workbook_inventory",
    ...
    "folder": ObjectReadContract(
        ...
        branch_semantics="inventory_only",
        revision_fields=(),
        compact_summary_schema="folder.inventory_row",
        structure_schema="folder.available_only_through_inventory_or_collection",
        artifact_schema="sanitized_workbook_inventory",
        dependency_extractors=(),
        redaction_policy="redact secret-like keys recursively",
        error_categories=("unavailable_api_method", "missing_input"),
    ...
    "compute": ObjectReadContract(
        ...
        branch_semantics="inventory_only",
        revision_fields=("revId", "savedId"),
        compact_summary_schema="compute.inventory_row",
        structure_schema="compute.available_only_through_workbook_inventory_and_relations",
        artifact_schema="sanitized_workbook_inventory",
        dependency_extractors=(),
    ...
    "dataset_field": ObjectReadContract(
        ...
        revision_fields=(),
        compact_summary_schema="dataset_field.embedded_in_dataset",
        structure_schema="dataset.fields.items",
        artifact_schema="sanitized_dataset_payload",
        dependency_extractors=(),
    ...
    "calculated_field": ObjectReadContract(
        ...
        branch_semantics="embedded_in_dataset",
        revision_fields=(),
        compact_summary_schema="calculated_field.embedded_in_dataset",
        structure_schema="dataset.fields.formulas",
        artifact_schema="sanitized_dataset_payload",
        dependency_extractors=(),
        redaction_policy="read via dataset summary/artifact",
        error_categories=("unavailable_api_method", "missing_input"),
