...
`"authoring_profile": {"id": "charging_v2_exact"}`. Тогда
`dl_generate_editor_bundle` автоматически встраивает точный 93 916-байтовый
Charging runtime, сверяет его SHA-256 и блокирует несовместимый route или
незарегистрированное семейство.
