...
route, изменившийся набор или незарегистрированное семейство. Историческое имя
профиля будет нормализовано в этот же контракт; descriptor с зарезервированным
именем или alias игнорируется. Повторный вызов использует кэшированный
fingerprint неизменившихся пакетных ресурсов.
