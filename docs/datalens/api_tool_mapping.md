...
| `dl_read_object` | `getDashboard`, `getWizardChart`, `getEditorChart`, `getQLChart`, `getDataset`, `getConnection` | Унифицированное чтение |
...
Точный метод и request schema возвращаются plan-инструментом до выполнения записи. Официальный источник: [DataLens API Reference](https://yandex.cloud/ru/docs/datalens/openapi-ref/).
