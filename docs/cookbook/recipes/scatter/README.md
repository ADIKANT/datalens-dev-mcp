...
[← Cookbook](../../README.md) · [Web](https://adikant.github.io/datalens-dev-mcp/recipes/scatter/?lang=ru)

![Точечная диаграмма](preview.svg)

Связь двух числовых показателей.

## Когда использовать

Поиск зависимости, кластеров и выбросов.

## Особенности поведения

Каждая строка становится одной точкой x/y.
