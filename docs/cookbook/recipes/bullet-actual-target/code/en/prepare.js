 ...
 */
// Prepare normalizes fields and keeps user edits in Meta and Sources.
...
const __DL_TITLE_CONTRACT = Object.freeze({"display_title":"Bullet: actual and target","family":"bullet_assignees","hint":"An actual value with a separate target marker.","issues":[],"mode":"embedded_title","mutual_exclusion":{"native_and_runtime_hint":"forbidden","native_and_runtime_title":"forbidden"},"native_metadata":{"enableHint":false,"hideTitle":true,"hint":"An actual value with a separate target marker.","title":"Bullet: actual and target"},"ok":true,"route":"editor_advanced","runtime":{"renders_content_label":false,"renders_hint":true,"renders_title":true},"schema_id":"dashboard_title_contract","sha256":"58863afe179e3a97570b0ed7dbc9a2860d44505e9cadb7d30e473085989bafce"});
...
const TEMPLATE_VARIANT = 'bullet_assignees';
