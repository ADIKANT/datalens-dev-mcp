...
[← Cookbook](../../README_en.md) · [Web](https://adikant.github.io/datalens-dev-mcp/recipes/histogram/?lang=en)

![Histogram](preview_en.svg)

Frequencies across precomputed bins.

## When to use it

Shape of a numeric distribution.

## Specific behavior

label is the bin label and value is its frequency; boundaries are computed before Sources.
