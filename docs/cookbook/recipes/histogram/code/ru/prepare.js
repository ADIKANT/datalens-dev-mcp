...
const __DL_TITLE_CONTRACT = Object.freeze({"display_title":"Гистограмма","family":"histogram","hint":"Частоты по заранее рассчитанным интервалам.","issues":[],"mode":"embedded_title","mutual_exclusion":{"native_and_runtime_hint":"forbidden","native_and_runtime_title":"forbidden"},"native_metadata":{"enableHint":false,"hideTitle":true,"hint":"Частоты по заранее рассчитанным интервалам.","title":"Гистограмма"},"ok":true,"route":"editor_advanced","runtime":{"renders_content_label":false,"renders_hint":true,"renders_title":true},"schema_id":"dashboard_title_contract","sha256":"67b7fb15f06e6af0785cfc95621847875a1f6913ee2541b580d1ca862659f24e"});
