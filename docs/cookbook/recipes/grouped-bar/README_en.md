...
[← Cookbook](../../README_en.md) · [Web](https://adikant.github.io/datalens-dev-mcp/recipes/grouped-bar/?lang=en)

![Grouped horizontal bars](preview_en.svg)

Multiple series inside shared categories.

## When to use it

Comparing segments or periods for each category.

## Specific behavior

group creates separate series and legend entries.
