...
[← Cookbook](../../README.md) · [Web](https://adikant.github.io/datalens-dev-mcp/recipes/donut/?lang=ru)

![Кольцевая диаграмма](preview.svg)

Состав целого с итогом в центре.

## Когда использовать

Небольшое число частей и важный общий итог.

## Особенности поведения

Центр показывает сумму value.
