...
[← Cookbook](../../README_en.md) · [Web](https://adikant.github.io/datalens-dev-mcp/recipes/matrix-heatmap/?lang=en)

![Matrix heatmap](preview_en.svg)

Intensity at the intersection of two categorical coordinates.

## When to use it

Finding hot spots by category and time interval or a second category.

## Specific behavior

label is the x coordinate, group is the y coordinate, and value controls color.
