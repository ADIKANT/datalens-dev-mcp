...
const __DL_TITLE_CONTRACT = Object.freeze({"display_title":"Матричная тепловая карта","family":"heatmap","hint":"Интенсивность на пересечении двух категориальных координат.","issues":[],"mode":"embedded_title","mutual_exclusion":{"native_and_runtime_hint":"forbidden","native_and_runtime_title":"forbidden"},"native_metadata":{"enableHint":false,"hideTitle":true,"hint":"Интенсивность на пересечении двух категориальных координат.","title":"Матричная тепловая карта"},"ok":true,"route":"editor_advanced","runtime":{"renders_content_label":false,"renders_hint":true,"renders_title":true},"schema_id":"dashboard_title_contract","sha256":"1111cec80763f8fc3e6ee5c5ba1d2e0ba29c7f9939200e9aeee90af6c6b81c2b"});
