 ...
 */
// Sankey uses separate nodes and links; cyclic transitions must be removed in Sources.
...
const __DL_TITLE_CONTRACT = Object.freeze({"display_title":"Sankey","family":"sankey_status_flow","hint":"Flows between nodes with link width proportional to volume.","issues":[],"mode":"embedded_title","mutual_exclusion":{"native_and_runtime_hint":"forbidden","native_and_runtime_title":"forbidden"},"native_metadata":{"enableHint":false,"hideTitle":true,"hint":"Flows between nodes with link width proportional to volume.","title":"Sankey"},"ok":true,"route":"editor_advanced","runtime":{"renders_content_label":false,"renders_hint":true,"renders_title":true},"schema_id":"dashboard_title_contract","sha256":"33a9e28af8648723cb56b6046fa9e3e72a42dd49c27ffd0b9010ab7abffba2a4"});
...
module.exports = {
  render: Editor.wrapFn({
    ...
    fn: function(options, data) {
      ...
      if (!data.rows.length) {
        return __dlGenerateProfileHtml(options, `<div style="box-sizing:border-box;width:100%;height:100%;padding:12px;background:${style.colors.surface};color:${style.colors.textMuted};font-family:Inter,Arial,sans-serif;">NO FLOW DATA</div>`);
      }
      ...
      if (changed) {
        return __dlGenerateProfileHtml(options, `<div style="box-sizing:border-box;width:100%;height:100%;padding:12px;background:${style.colors.surface};color:${style.colors.textMuted};font-family:Inter,Arial,sans-serif;">N/A · cyclic_flow</div>`);
      }
