...
module.exports = {
  controls: [
    ...
    },
    {
      ...
      multiselect: false,
      searchable: false,
      content: [{"title": "All", "value": "all"}, {"title": "Open", "value": "open"}, {"title": "Done", "value": "done"}],
    },
    {
      type: 'select',
      param: "segment",
