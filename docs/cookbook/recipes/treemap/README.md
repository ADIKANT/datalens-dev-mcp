...
[← Cookbook](../../README.md) · [Web](https://adikant.github.io/datalens-dev-mcp/recipes/treemap/?lang=ru)

![Иерархическая карта](preview.svg)

Площадь прямоугольников пропорциональна частям целого.

## Когда использовать

Состав с большим диапазоном размеров частей.

## Особенности поведения

Мелкие подписи скрываются, но прямоугольники сохраняются.
