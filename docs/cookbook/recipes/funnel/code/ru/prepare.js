 ...
 */
// Prepare принимает временные интервалы из Sources и не требует изменений при стабильных aliases.
...
const __DL_TITLE_CONTRACT = Object.freeze({"display_title":"Воронка","family":"funnel_snapshot","hint":"Последовательные этапы и уменьшающийся объём.","issues":[],"mode":"embedded_title","mutual_exclusion":{"native_and_runtime_hint":"forbidden","native_and_runtime_title":"forbidden"},"native_metadata":{"enableHint":false,"hideTitle":true,"hint":"Последовательные этапы и уменьшающийся объём.","title":"Воронка"},"ok":true,"route":"editor_advanced","runtime":{"renders_content_label":false,"renders_hint":true,"renders_title":true},"schema_id":"dashboard_title_contract","sha256":"1bdbd21649c1250d4ffdd915b69ddf5a4e47e29be830086925d70f87e964e165"});
...
const TEMPLATE_VARIANT = 'funnel_snapshot';
  ...
  render: Editor.wrapFn({
    ...
    fn: function(options, data) {
      ...
      if (data.variant === 'funnel_snapshot') {
        ...
        return __dlGenerateProfileHtml(options, `<div style="box-sizing:border-box;width:100%;height:100%;padding:12px 14px;background:${style.colors.surface};font-family:Inter,Arial,sans-serif;overflow:hidden;">${funnel}</div>`);
      }
      ...
      return __dlGenerateProfileHtml(options, `<div style="box-sizing:border-box;width:100%;height:100%;padding:${compact ? 8 : 12}px ${compact ? 8 : 14}px;background:${style.colors.surface};font-family:Inter,Arial,sans-serif;line-height:1.25;overflow:hidden;">${legend}${svg}</div>`);
    },
  }),
};
