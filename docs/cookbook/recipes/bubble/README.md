...
[← Cookbook](../../README.md) · [Web](https://adikant.github.io/datalens-dev-mcp/recipes/bubble/?lang=ru)

![Пузырьковая диаграмма](preview.svg)

Связь x/y с третьим показателем в размере.

## Когда использовать

Сравнение положения и масштаба объектов.

## Особенности поведения

size должен быть положительным; площадь ограничивается для читаемости.
