...
[← Cookbook](../../README_en.md) · [Web](https://adikant.github.io/datalens-dev-mcp/recipes/bubble/?lang=en)

![Bubble chart](preview_en.svg)

An x/y relationship with a third measure encoded by size.

## When to use it

Comparing both position and scale of items.

## Specific behavior

size must be positive; area is capped for readability.
