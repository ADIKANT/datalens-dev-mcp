...
const __DL_TITLE_CONTRACT = Object.freeze({"display_title":"Пузырьковая диаграмма","family":"bubble","hint":"Связь x/y с третьим показателем в размере.","issues":[],"mode":"embedded_title","mutual_exclusion":{"native_and_runtime_hint":"forbidden","native_and_runtime_title":"forbidden"},"native_metadata":{"enableHint":false,"hideTitle":true,"hint":"Связь x/y с третьим показателем в размере.","title":"Пузырьковая диаграмма"},"ok":true,"route":"editor_advanced","runtime":{"renders_content_label":false,"renders_hint":true,"renders_title":true},"schema_id":"dashboard_title_contract","sha256":"a75aa3d7acc6b4ddc7201d8a0fa443c77aecd78c60a816893853de7027108dba"});
