...
[← Cookbook](../../README_en.md) · [Web](https://adikant.github.io/datalens-dev-mcp/recipes/waterfall/?lang=en)

![Waterfall](preview_en.svg)

Sequential positive and negative contributions.

## When to use it

Explaining movement from a starting level to a final level.

## Specific behavior

Row order is preserved; each row changes the running total.
