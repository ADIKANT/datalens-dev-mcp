...
| Реализация MCP | Доступные 39 инструментов, их входы и результаты | [Справочник инструментов](tools.md), [технический каталог](mcp/tools.md), [покрытие API](datalens/api_contract_coverage.md) |
