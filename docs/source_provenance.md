...
Единственный исполняемый встроенный профиль `standard_dashboard_v1` ссылается
только на актуальный реестр шаблонов этого репозитория. Он фиксирует 39
семейств и 74 assets общим SHA-256
`6ce84e5e14cefa09beb8774f5d8b306fdaee212532fbfda8b5acebd5e4ca20a4`.
Исторические имена являются aliases этого профиля и не открывают доступ к
старым assets. Каждый скомпилированный bundle дополнительно содержит
fingerprints выбранных assets, render-контракта и итоговых вкладок.
