...
def test_static_selector_exports_documented_controls_and_string_defaults(tmp_path):
    draft = compile_recipe("selector", {"parameter": {"name": "region", "default": 7},
        "options": [{"title": "Synthetic region", "value": 7}], "consumers": ["synthetic-chart"]},
    ...
    params = subprocess.check_output(["node", "-e", draft["tabs"]["params.js"] + "console.log(JSON.stringify(module.exports));"], text=True)
