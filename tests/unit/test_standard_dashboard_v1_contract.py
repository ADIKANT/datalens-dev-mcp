...
from datalens_dev_mcp.pipeline.browser_qa import (
    ...
    BROWSER_QA_RESULT_SCHEMA_VERSION,
...
FIXTURE_ROOT = Path(__file__).parents[1] / "fixtures" / "standard_dashboard_v1"


class StandardDashboardV1ContractTests(unittest.TestCase):
    ...
    def test_positive_dashboard_shape_fixtures_compile(self):
        ...
        for fixture_name in fixture_names:
            with self.subTest(fixture=fixture_name):
                ...
                self.assertEqual(composition["version"], 2)
    ...
    def test_safe_apply_normalizes_legacy_alias_and_requires_current_attestation(self):
                ...
                actions=[
                    {
                        ...
                        "action_type": "create",
                        "authoring_profile_id": "standard_editor_v1",
        ...
        self.assertFalse(any("standard_editor_v1 is forbidden" in issue for issue in result["issues"]))
        self.assertTrue(
